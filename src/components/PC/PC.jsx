...
const PC = () => {
  ...
  const handleShowMore = () => {
    setVisibleCards((prev) => Math.min(prev + 4, pcItems.length));
  };
  ...
  return (
    <div className="p-8 w-full bg-gray-100">
        ...
        <div className="fixed inset-0 bg-transparent flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl text-center h-[300px]">
            ...
            <div className="flex justify-center gap-6">
              ...
              <button
                onClick={() => setShowModal(false)} // You can use navigate later
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {pcItems.slice(0, visibleCards).map((pcItem) => (
          <div
            key={pcItem.id}
          ...
          >
            ...
            <div className="absolute top-3 right-3 flex gap-2">
              <button
                onClick={(e) => handleAddToCart(pcItem, e)}

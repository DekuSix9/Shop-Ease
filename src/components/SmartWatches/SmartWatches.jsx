...
import { useCart } from "../CartContext/CartContext"; // ✅ Cart context
...
const SmartWatches = () => {
  ...
  return (
    <div className="p-8 w-full bg-gray-100">
        ...
        <div className="fixed inset-0 bg-transparent flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl text-center h-[300px]">
            ...
            <div className="flex justify-center gap-6">
              ...
              <button
                onClick={() => setShowModal(false)} // ✅ Replace with navigate('/cart') if needed
      ...
      {/* ✅ Grid of smartwatches */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {smartwatches.slice(0, visibleCards).map((watch) => (
          <div
            key={watch.id}
